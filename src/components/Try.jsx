...
function Try() {
  ...
  return (
    <section>
      {" "}
      <div className="row">
        <div className="  bg_light_gray py-xl-4 py-3 h_100_vh overflow-custom  ">
          <div className={nav ? " overflow-hidden" : "overflow-auto "}>
            <div className="w-100 h-100 ">
              <div className="mt-4 mt-lg-0 z_index1 d-flex justify-content-between align-items-center ">
                <label className="width_lable" htmlFor="id">
                  <span className="search_input py-3 px-3 ">
                    ...
                    <input
                      type="Search"
                      placeholder="Search..."
                      className="ff_liber text_tertiary fw-normal "
                    />
                    <a href="#">
                      <img
                        style={({ width: "15px" }, { height: "12px" })}
                        src={SettingSearchIcon}
                        alt="img"
                      />
                    </a>
                  </span>
                ...
                >
                  <div
                    className={
                      nav
                        ? "Hamburger-child "
                        : "Hamburger-child  Hamburger-child-onchange"
                    }
                  ></div>
                  <div
                    className={
                ...
                <div className={nav ? "Hide-content" : "Show-content"}>
                  <div className=" px-0 overflow-hidden">
                    <div>
                      <div className=" d-flex justify-content-start  px-lg-4 px-2  mb-3 mb-xl-5 py-xl-5 py-lg-3 py-2 position-relative">
                        <svg
                          style={{ zIndex: "-1" }}
                      ...
                      <div className="d-flex gap-3  align-items-start d-md-none  px-lg-4 px-2 pb-2  ">
                        <a href="#">
                          <img
                ...
                <div className="d-flex gap-xl-4 gap-lg-3 gap-2 align-items-center ">
                  <div className="d-flex me-5 gap-xl-4 gap-lg-3 gap-2 d-none d-lg-flex">
                    <span>
                      <a href="#">
                        <img
                          style={({ width: "18px" }, { height: "19px" })}
              ...
              <div className="row mt-3">
                <div className="col-lg-8 col-md-6 pt-2 mb-5">
                  <div className=" row create_box_bg mx-2 mb-5 justify-content-between h-100">
                    <div className="col-xl-6 d-flex align-items-center">
                      <div className="ps-lg-4 ps-sm-3 ps-2 z_index pb-xxl-4 pb-sm-3 pb-2 pb-xl-0 ">
                        <h3 className="text_primary ps-1 ff_inter fw_medium fs_xl  mb-0">
                          Create MetroVerse Genesis
                        </h3>
                        <p className="py-xxl-4 py-2 ps-1 ff_inter fw_500 fs_md text_secondary mb-0">
                        ...
                        <div className="mt-3 item_outline d-flex justify-content-between mb-4">
                          <div className="py-lg-3 py-2 px-lg-3 px-2 last_outline">
                            <p className="ff_inter fw-bold fs_md text_primary mb-0 text-center">
                              24.8K{" "}
                            </p>
                          ...
                          <div className="py-lg-3 py-2 px-lg-3 px-2 ">
                            <p className="ff_inter fw-bold fs_md text_primary mb-0 text-center">
                              43.1K{" "}
                            </p>
                            <p className="ff_inter fw_500 fs_xsm text_secondary mb-0 text-center pe-2 pt-1">
                              Volumn Traded
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="col-xl-6">
                      {" "}
                      <img
                        className="w-100 create_box_img"
                        src={scoreimg}
                        alt="data"
                      />
                    </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="h-100  d-flex flex-column justify-content-betwee ">
                    <p className=" ff_inter fw_semibold fs_xl text_tertiary mt-5 mt-lg-0">
                      New NFTs
                    </p>
                    <div className="h-100 d-flex flex-column justify-content-evenly justify-content-xl-start ">
                      <div className="d-flex align-items-center bg_white px-2 py-2 rounded-4">
                        <img
                          className="Img_block"
                          src={block_1}
                          alt="block_1"
                        />
                        <div className="w-100 me-2 ms-3">
                          <p className=" ff_inter fw_medium fs_sm text_secondary mb-0">
                            Metroverse Genesis
                          </p>
                          <p className=" ff_inter fw_bold fs_xl text_tertiary mb-0 ">
                            Block #1460
                          </p>
                          <p className=" ff_inter fw_medium fs_sm text_secondary  mb-0">
                            Owned by{" "}
                            <span className=" ff_inter fw_bold fs_sm text_linear">
                              BabyKee
                            </span>
                          </p>
                      ...
                      <div className="d-flex align-items-center bg_white px-2 py-2 rounded-4 mt-2">
                        <img
                          className="Img_block"
                          src={block_2}
                          alt="block_2"
                        />
                        <div className=" ms-3 w-100 me-2 ms-3 ">
                          <p className=" ff_inter fw_medium fs_sm text_secondary mb-0">
                            Metroverse Genesis
                          </p>
                          <p className=" ff_inter fw_bold fs_xl text_tertiary mb-0 ">
              ...
              <div>
                <div className="row justify-content-between">
                  <div className="col-lg-8 ">
                    {" "}
                    <div className=" row pt-4 mx-2 d-none d-md-flex mb-3 mb-xxl-4 d-none d-md-flex">
                      <div className="d-flex justify-content-between">
                        {" "}
                        <h2 className="ff_inter fw-semibold fs_xl text_tertiary">
                          Top Collections
                        </h2>
                        <p className="ff_inter fw-semibold fs_md text_tertiary">
                          View All{" "}
                          <span>
                      ...
                      <div className="col-md-4 col-sm-6 mt-3">
                        <div className=" position-relative overflow-hidden rounded-4">
                          <div className="overlay position-absolute d-flex justify-content-center flex-column align-items-center pb-2">
                            <img
                              className="width_history_images"
                              src={dragn}
                              alt="imgg-dragn"
                            />
                    ...
                    <Carousel className=" d-md-none">
                      <Carousel.Item>
                        ...
                        <div className="row">
                          {" "}
                          <div className="col-md-4 col-sm-6 mt-3  d-none d-sm-block">
                            <div className=" position-relative overflow-hidden rounded-4">
                              <div className="overlay position-absolute d-flex justify-content-center flex-column align-items-center pb-2">
                                <img
                                  className="width_history_images"
                    ...
                    <div className="row pt-4 mx-2 d-none d-md-flex  d-none d-md-flex ">
                      <div className="d-flex justify-content-between">
                        {" "}
                        <h2 className="ff_inter fw-semibold fs_xl text_tertiary">
                          Trendings NFTs
                  ...
                  <div className="col-lg-4 ">
                    <div className="">
                      <div className="row flex-xl-column">
                        {" "}
                        <div className=" mt-5 bg_white rounded-4 pb-4">
                          ...
                          <div className="d-flex align-items-center justify-content-between pe-4 px-3 mt-4">
                            <div className=" d-flex align-items-center">
                              ...
                              <div className=" ms-3 d-flex justify-content-between">
                                <div>
                                  <p className=" ff_inter fw_bold fs_lg text_tertiary mb-0">
                                    Cet #6882
                                  </p>
                          ...
                          <a
                            className=" ff_inter fw_medium fs_lg text-white d-flex justify-content-center py-3 mt-5 d-inline-block search_btn mx-3"
                            href="#"
                          >
                            Show All
                          </a>
