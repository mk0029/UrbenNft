      ...
      <section>
        <div className="d-flex  max-vh-100 ">
          ...
          <div
            className={
              nav
                ? "Shownav d-lg-none overflow_custom"
                : "Hidenave d-lg-none overflow_custom"
            }
          >
            <div className="overflow_custom ">
              {" "}
              <div className="min_width_310    d-lg-flex position-relative min_h_1024 d-flex flex-column">
                <img
                  className=" position-absolute bgWAVSlogo w-100 z_index0"
                  src={bgWavs}
                  alt="bgwavs"
          ...
          <div className="overflow_custom d-flex flex-column flex-lg-grow-1 bg_light_gray w-100  ">
            <div className=" container">
              ...
              <nav className="w-100 ">
                <div className=" d-flex justify-content-between">
                  ...
                  <div
                    className="sapnparant d-lg-none"
                    onClick={() => setnav(!nav)}
                  >
                    <span className={nav ? "spanchild1false" : ""}></span>
                    <span className={nav ? "spanchild2false " : "my-2"}></span>
                    <span className={nav ? "spanchild3false" : ""}></span>
                  </div>
